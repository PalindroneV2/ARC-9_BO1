...
SWEP.WorldModel = "models/weapons/arc9/c_bo1_asp.mdl"
...
SWEP.Hook_ModifyBodygroups = function(self, data)
    ...
    local camo = 4
    local newpos = Vector(-3.045, -1, 1.5) -- M39
    local newang = Angle(0.1, 1.35, 0) -- M39

    vm:SetBodygroup(1,1)
    if attached["asp"] then
        vm:SetBodygroup(1,0)
        newpos = Vector(-3.05, -1, 1.825)
        newang = Angle(0, 0, 0)
    end
    if attached["hush"] then
        vm:SetBodygroup(1,2)
        newpos = Vector(-2.965, -1, 1.5)
        newang = Angle(0.3, 0.9, 0)
    end
